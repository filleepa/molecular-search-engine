...
insert_pipe = (pipe.input("df")
               ...
               .map("smiles", "fp", ops.molecular_fingerprinting.rdkit(algorithm="daylight")) # use the daylight algorithm to generate fingerprint with the rdkit operator in towhee hub
